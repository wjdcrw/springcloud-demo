    ...
    public Server choose(Object key) {
        try {
            ...
            if(theSameClusterNameInstList.isEmpty()) {
                ...
                toBeChooseInstance = MyWeightedBalancer.chooseInstanceByRandomWeight(allInstance);
                ...
                toBeChooseInstance = MyWeightedBalancer.chooseInstanceByRandomWeight(theSameClusterNameInstList);
